        ...
        <Row xs={1} md={3} className="justify-content-center">
          {cards.map((card, index) => (
            <Plan
              ...
              css={card.featured && card.type === 2 && highlightGradientsCss[2]}
              style={{
            ...
            >
              ...
              {!card.featured && (
                <div
                  ...
                  css={highlightGradientsCss[card.type]}
                />
              )}
              <PlanHeader>
              ...
              <PlanAction>
                <BuyNowButton
                  ...
                  css={
                    (!card.featured && highlightGradientsCss[card.type]) ||
                    (card.featured &&
                      card.type === 2 &&
                      highlightGradientsCss[3])
                  }
                >
                  {card.button}
                </BuyNowButton>
